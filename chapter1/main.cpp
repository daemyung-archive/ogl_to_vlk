...
private:
    void init_signals_()
    {
        window_->startup_signal.connect(this, &Chapter1::on_startup);
        window_->shutdown_signal.connect(this, &Chapter1::on_shutdown);
        window_->render_signal.connect(this, &Chapter1::on_render);
    }
...
int main(int argc, char* argv[])
{
    ...
    window_desc.title = L"Chapter1"s;
    window_desc.extent = {512, 512, 1};

    Window window {window_desc};

    Chapter1 chapter1 {&window};
