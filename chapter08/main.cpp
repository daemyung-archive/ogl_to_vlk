...
private:
    ...
    {
        {
            // 버텍스 셰이더 스테이지에서 사용될 버텍스 셰이더를 정의합니다.
            // gl_VertexIndex는 VKSL의 내장 변수이며 현재 스레드의 버텍스 인덱스를 의미합니다.
            // 버텍스 버퍼가 없기 때문에 위치 정보를 셰이더에 정의합니다.
            const string vksl = {
                "void main() {                                          \n"
        ...
        {
            // 프래그먼트 셰이더 스테이지에서 사용될 프래그먼트 셰이더를 정의합니다.
            // 간단하게 초록색을 출력합니다.
            const string vksl = {
    ...
    void init_pipeline_()
    {
        ...
        // 버텍스 버퍼를 읽지 않는 파이프라인 버텍스 인풋 스테이지를 정의합니다.
